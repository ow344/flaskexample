...
@user1.route('/user/changeschool', methods=['GET', 'POST'])
def changeschool():
...
##################### Staff #####################
@user1.route('/user/stafflist', methods=['GET', 'POST'])
def stafflist():
...
@user1.route('/user/stafflist/staff/<int:staff_id>')
...
##################### Request Forms #####################
##################### R2R #####################
@user1.route('/user/requestforms/r2r/pending', methods=['GET', 'POST'])
...
@user1.route('/user/requestforms/r2r/form', methods=['GET', 'POST'])
...
@user1.route('/user/requestforms/r2r/edit/<int:r2r_id>', methods=['GET', 'POST'])
...
@user1.route('/sendcomment1/<int:r2r_id>', methods=['POST'])
...
##################### Onboard #####################
@user1.route('/user/requestforms/onboard/pending', methods=['GET', 'POST'])
...
@user1.route('/user/requestforms/onboard/form', methods=['GET', 'POST'])
...
@user1.route('/user/requestforms/onboard/form2/<int:r2r_id>', methods=['GET', 'POST'])
...
@user1.route('/user/requestforms/onboard/edit/<int:onboard_id>', methods=['GET', 'POST'])
...
@user1.route('/user/requestforms/variation/form/<int:staff_id>', methods=['GET', 'POST'])
...
@user1.route('/update_text', methods=['POST'])
def update_text():
